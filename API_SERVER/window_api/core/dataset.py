...
class Dataset(object):
    ...
    def load_annotations(self):
        annotations = []
        for file_num in os.listdir(self.annot_path): # 디렉토리를 조회한다
            
            # if file_num 이 .txt로 끝나면 :
            #     txt_data.append(os.path.join(self.annot_path, file_num))
            # else file_num 이 .png로 끝나면:
            #     image_data.append(os.path.join(self.annot_path, file_num))
            file_path = os.path.join(self.annot_path, file_num)
            ...
            if child == '.txt':
                ...
                #             # print('궁금한 루트',root)                        
                image_path = self.annot_path+'/' + root + '.png'
            ...
            elif child =='.png' or child =='.jpg':
                print('잘읽는 파일 png, jpg',file_path)
